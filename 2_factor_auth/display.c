...
unsigned char g_pucDispSysIPAdd[]="IP Addr:   .   .   .   \0";

unsigned char *g_pucDispStatus;
unsigned char g_aucDispStatus[5][30]={{""},
		{"Status: Code Request Sent\0"},
		{"Status: Access Request Sent\0"},
		{"Status: Access Granted\0"},
		{"Status: Access Denied\0"}};

unsigned char *g_pucDispTitle;
unsigned char g_pucDispTitleUserID[]="Enter User ID\0";
unsigned char g_pucDispTitleAccessID[]="Enter Access Code\0";
...
void displayInit(){
	...
	g_pucDispTitle = g_pucDispTitleUserID;
...
void displayInitComplete(unsigned long ulIPAddress){
	...
	g_ucDispBaseHL[DISP_ELEM_HL_SYS_STAT] = 4;
	g_ucDispBaseHL[DISP_ELEM_HL_IP_ADDR] = 4;
